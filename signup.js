...
// passWord.addEventListener("click", myFunction);
// // passWord.addEventListener("focus", myFunction);

// var passWord = document.getElementById("phone");
// passWord.addEventListener("click", thisFunction);
// // passWord.addEventListener("focus", thisFunction);
...
//     return thisFunction; //if password is clicked, run thisFunction
//   } else if (event.target.matches("#phone")) {
//     return thisFunction; //if password is clicked, run thisFunction
//   } else {
